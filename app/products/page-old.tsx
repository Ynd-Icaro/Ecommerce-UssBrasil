    ...
    <div className="min-h-screen bg-uss-off-white dark:bg-uss-gray-900">
      ...
      <div className="bg-white dark:bg-uss-gray-800 border-b border-uss-gray-300 dark:border-uss-gray-600">
        <div className="container mx-auto px-4 py-8">
          ...
          >
            <h1 className="text-4xl font-bold text-uss-gray-900 dark:text-white mb-4">
              Nossos <span className="text-gradient-uss bg-clip-text">Produtos</span>
            </h1>
            <p className="text-xl text-uss-gray-600 dark:text-uss-gray-400 max-w-2xl mx-auto">
              Descubra a mais completa seleção de produtos premium de tecnologia
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="hidden lg:block w-80 flex-shrink-0">
            <div className="bg-white dark:bg-uss-gray-800 rounded-xl border border-uss-gray-300 dark:border-uss-gray-600 p-6 sticky top-24">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-uss-gray-900 dark:text-white">
                  Filtros
                </h2>
                <button
                  onClick={clearFilters}
                  className="text-sm text-uss-primary dark:text-uss-secondary hover:underline"
                >
                  Limpar Todos
                </button>
              </div>
              ...
              {/* Busca */}
              <div className="mb-6">
                <label className="block text-sm font-medium text-uss-gray-700 dark:text-uss-gray-300 mb-2">
                  Buscar
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="w-full pl-10 pr-4 py-2 border border-uss-gray-300 dark:border-uss-gray-600 rounded-lg bg-white dark:bg-uss-gray-700 text-uss-gray-900 dark:text-white focus:ring-2 focus:ring-uss-primary dark:focus:ring-uss-secondary"
                  />
                </div>
              </div>
              ...
              {/* Marcas */}
              <div className="mb-6">
                <label className="block text-sm font-medium text-uss-gray-700 dark:text-uss-gray-300 mb-3">
                  Marcas
                </label>
                <div className="space-y-2 max-h-48 overflow-y-auto">
                  {uniqueBrands.map(brand => (
                    <label key={brand} className="flex items-center">
                      <input
                        ...
                        className="rounded border-uss-gray-300 text-uss-primary focus:ring-uss-primary"
                      />
                      <span className="ml-2 text-sm text-uss-gray-700 dark:text-uss-gray-300">
                        {brand}
                      </span>
                    </label>
                  ))}
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-uss-gray-300 dark:border-uss-gray-600 rounded-lg bg-white dark:bg-uss-gray-700 text-uss-gray-900 dark:text-white"
                    />
                    <span className="text-uss-gray-500">-</span>
                    <input
                      type="number"
                      placeholder="Máx"
                    ...
                    <label key={rating} className="flex items-center">
                      ...
                      <div className="ml-2 flex items-center">
                        {Array.from({ length: rating }).map((_, i) => (
                          <Star key={i} className="h-4 w-4 fill-uss-warning text-uss-warning" />
                        ))}
                        <span className="ml-1 text-sm text-uss-gray-700 dark:text-uss-gray-300">
                          {rating}+ estrelas
                        </span>
                      </div>
                    </label>
          ...
          <div className="flex-1">
            ...
            <div className="bg-white dark:bg-uss-gray-800 rounded-xl border border-uss-gray-300 dark:border-uss-gray-600 p-4 mb-6">
              <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className="lg:hidden flex items-center space-x-2 px-3 py-2 border border-uss-gray-300 dark:border-uss-gray-600 rounded-lg text-uss-gray-700 dark:text-uss-gray-300 hover:bg-uss-gray-50 dark:hover:bg-uss-gray-700"
                  >
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <select
                    value={sortBy}
                    onChange={(e) => setSortBy(e.target.value)}
                    className="px-3 py-2 border border-uss-gray-300 dark:border-uss-gray-600 rounded-lg bg-white dark:bg-uss-gray-700 text-uss-gray-900 dark:text-white text-sm"
                  >
                  ...
                  <div className="flex items-center border border-uss-gray-300 dark:border-uss-gray-600 rounded-lg">
                    <button
                      ...
                      className={`p-2 ${viewMode === 'grid' 
                        ? 'bg-uss-primary text-white' 
                        : 'text-uss-gray-600 dark:text-uss-gray-400'
                      }`}
                    >
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg transition-colors ${
                      currentPage === page
                        ? 'bg-uss-primary text-white'
                        : 'bg-white dark:bg-uss-gray-800 text-uss-gray-700 dark:text-uss-gray-300 border border-uss-gray-300 dark:border-uss-gray-600 hover:bg-uss-gray-50 dark:hover:bg-uss-gray-700'
                    }`}
                  >
                    {page}
                  </button>
        ...
        {isFilterOpen && (
          ...
          >
            ...
            <motion.div
              ...
              animate={{ x: 0 }}
              exit={{ x: '-100%' }}
              className="absolute left-0 top-0 h-full w-80 bg-white dark:bg-uss-gray-800 p-6 overflow-y-auto"
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-uss-gray-900 dark:text-white">
                  Filtros
                ...
                <button
                  onClick={() => setIsFilterOpen(false)}
                  className="p-2 text-uss-gray-500 hover:text-uss-gray-700 dark:hover:text-uss-gray-300"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
              
              {/* Conteúdo dos filtros mobile aqui - mesmo conteúdo da sidebar */}
              {/* ... */}
              
              <div className="mt-6 flex space-x-3">
                <button
                  onClick={clearFilters}
                  className="flex-1 px-4 py-2 border border-uss-gray-300 dark:border-uss-gray-600 rounded-lg text-uss-gray-700 dark:text-uss-gray-300"
                >
                  Limpar
                </button>
                <button
                  onClick={() => setIsFilterOpen(false)}
                  className="flex-1 px-4 py-2 bg-uss-primary text-white rounded-lg"
                >
                  Aplicar
                </button>
              </div>

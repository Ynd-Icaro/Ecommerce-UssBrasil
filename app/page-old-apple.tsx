      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              { name: 'iPhone', image: '/Produtos/Apple/Iphone 16 Pro.png', count: 12 },
              { name: 'Mac', image: '/Produtos/Apple/Macbook Pro.png', count: 8 },
              { name: 'iPad', image: '/Produtos/Apple/Ipad Pro.png', count: 6 },
              { name: 'Watch', image: '/Produtos/Apple/Watch Series 10.png', count: 4 },
              { name: 'AirPods', image: '/Produtos/Apple/Air Pods Max.png', count: 5 }
            ].map((category, index) => (
              <motion.div
                key={category.name}
                initial={{ opacity: 0, y: 30 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Veja os Produtos em Ação
            </h2>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
              Descubra todos os detalhes dos nossos produtos através de vídeos demonstrativos em alta qualidade
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: 'Conheça o iPhone mais avançado'
              },
              {
                title: 'MacBook Pro M3',
                video: '/Videos/Macs Video.mp4', 
                thumbnail: '/Produtos/Apple/Macbook Pro.png',
                description: 'Performance revolucionária'
              },
              {
                title: 'iPad Pro',
                video: '/Videos/IpadVideo.mp4',
              ...
              >
                <Link href="/videos">
                  <div className="relative bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:transform hover:scale-105">
          ...
          >
            <Link href="/videos">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-[#00CED1] to-[#20B2AA] hover:from-[#20B2AA] hover:to-[#00CED1] text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                Ver Todos os Vídeos
              </Button>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                {/* Adicionar Logo /empresa/02.png */}
                <img src="/empresa/01.png" alt="Logo UssBrasil" className="w-full h-full" />
              </div>

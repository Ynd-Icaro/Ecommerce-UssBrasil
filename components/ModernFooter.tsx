    ...
    <footer className="bg-uss-gray-900 text-white relative overflow-hidden">
      ...
      {showScrollTop && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 p-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
        >
